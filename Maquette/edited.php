          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped">
              <thead class="text-center">
                <tr>
                  <th class="th-25 text-center">Mois</th>
                  <th class="th-25 text-center">Modifié le</th>
                  <th class="th-25 text-center">Regarder</th>
                  <th class="th-25 text-center">Edition</th>
                </tr>
              </thead>
              <tbody>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr class="text-center">
                  ...
                  <td>
                    <i class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip-month" data-placement="top" title="Le mois n'est pas encore en cours"></i>
                    L'edition n'est pas encore possible
                  </td>
                </tr>
                <tr class="text-center">
                  <td>Janvier 2018</td>
